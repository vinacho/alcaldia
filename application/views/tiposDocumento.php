		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#">Parametrización de típos de documentos personas</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Típos de documentos personas </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action='' method="POST">
						  <fieldset>
						  	...
						  	<a href="#" id="btnAgregarDoc" class="btn btn-success" data-toggle='modal' data-target='#myModal'><i class="icon-plus icon-white"></i> Nuevo típo de documento</a>
							...
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>
										...
										foreach($tiposDocumento as $fila){
											$fila = "<tr>" .
														"<td class='center'>" . $fila['COD_TIP_DOC'] . "</td>" .
														"<td class='center'>" . $fila['NOM_TIP_DOC'] . "</td>" .
														"<td class='center'> " .
						  ...
						  <div class="modal hide fade" id="myModal">
							<div class="modal-header">
								...
								<h3>Parametrización - típos de documentos personas</h3>
							</div>
